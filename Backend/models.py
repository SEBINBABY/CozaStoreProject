...
class CategoryDB(models.Model):
    ...
    CATDESC = models.CharField(max_length=100, null=True, blank=True)
...
class ProdcutDB(models.Model):
    ...
    PROPRICE = models.IntegerField(max_length=100, null=True, blank=True)
    ...
    PROIMAGE2 = models.ImageField(upload_to='Images', null=True, blank=True)
